...
```bash
node pwcli/resources/archify/renderers/lifecycle/render-lifecycle.mjs input.lifecycle.json output.html
```

The renderer validates input against
`pwcli/resources/archify/schemas/lifecycle.schema.json`
...
`pwcli/resources/archify/examples/agent-run.lifecycle.json`.
