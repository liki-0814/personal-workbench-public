...
use crate::config::{load_permission_config, save_permission_config, PermissionAllowRule};
...
impl PermissionPolicy {
    fn default_overrides() -> HashMap<String, PermissionMode> {
        ...
        map.insert("list_directory".to_string(), PermissionMode::Auto);
        map.insert("read_file".to_string(), PermissionMode::Auto);
        map.insert("read_artifact".to_string(), PermissionMode::Auto);
        map.insert("search_files".to_string(), PermissionMode::Auto);
        map.insert("get_file_info".to_string(), PermissionMode::Auto);
        // 写操作：询问
        map.insert("write_file".to_string(), PermissionMode::Prompt);
        map.insert("edit_file".to_string(), PermissionMode::Prompt);
        map.insert("remove_file".to_string(), PermissionMode::Prompt);
        // Shell 执行：询问（高风险）
        map.insert("run_command".to_string(), PermissionMode::Prompt);
        map
    }
...
mod tests {
    ...
    fn test_default_policy() {
        ...
        assert_eq!(policy.mode_for_tool("write_file"), PermissionMode::Prompt);
        assert_eq!(policy.mode_for_tool("edit_file"), PermissionMode::Prompt);
