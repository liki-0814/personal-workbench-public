use crate::runtime::permissions::{PermissionEngine, PermissionOutcome};
...
mod tests {
    use super::*;
    use crate::runtime::permissions::PermissionPolicy;

    #[tokio::test]
    async fn test_executor_allow() {
        let registry = crate::runtime::tools::registry::ToolRegistry::new();
        registry.register(
            "echo",
            "Echo",
            serde_json::json!({}),
