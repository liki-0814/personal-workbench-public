...
use crate::ai::llm::{summarize_via_llm_limited, LlmClient, SummarizeError};
use crate::ai::usage::UsageTracker;
use crate::runtime::memory::store::{MemoryMeta, MemoryStore};
...
pub async fn maybe_compact_memory(
    ...
    let _ = crate::runtime::memory::sync_index::best_effort_reindex(store);
...
pub fn should_auto_compact(
    store: &MemoryStore,
) -> Result<bool, crate::runtime::memory::store::MemoryError> {
