...
use crate::runtime::memory::{
    maybe_compact_memory, should_auto_compact, MemoryCompactOutcome, MemoryStore,
};
...
async fn run_maintenance(
    ...
    match crate::runtime::memory::maybe_dream(
        store,
        llm,
        &mut tracker,
        session_messages,
    ...
    .await
    {
        crate::runtime::memory::DreamOutcome::Completed => info!("background Dream completed"),
        crate::runtime::memory::DreamOutcome::Failed(error) => {
            warn!(%error, "background Dream failed")
        }
        crate::runtime::memory::DreamOutcome::Disabled
        | crate::runtime::memory::DreamOutcome::Skipped(_) => {}
    }
