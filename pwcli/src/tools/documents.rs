...
use crate::documents::{CreateDocument, DocumentKind, EvidenceEntry, UpdateDocument};
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let document = crate::documents::create(
                    &data_dir,
                    CreateDocument {
                        kind: args.kind,
                        title: args.title,
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let document = crate::documents::read(
                    &crate::config::local_config::data_dir(),
                    &args.document_id,
                )?;
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let view = crate::documents::read_evidence_ledger(
                    &crate::config::local_config::data_dir(),
                    &args.document_id,
                )?;
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let ledger = crate::documents::replace_evidence_ledger(
                    &crate::config::local_config::data_dir(),
                    &args.document_id,
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let data_dir = crate::config::local_config::data_dir();
                let current = crate::documents::read(&data_dir, &args.document_id)?;
                ...
                let document = crate::documents::update(
                    &data_dir,
                    &args.document_id,
                    UpdateDocument {
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let filename = source
                    ...
                    .unwrap_or("asset");
                let path =
                    crate::documents::store_asset(&data_dir, &args.document_id, filename, &bytes)?;
    ...
    registry.register_structured_with_impact(
        ...
        Box::new(|value| {
            ...
            Box::pin(async move {
                ...
                let data_dir = crate::config::local_config::data_dir();
                let document = crate::documents::read(&data_dir, &args.document_id)?;
...
fn resolve_generated_image(data_dir: &Path, image_url: &str) -> Result<std::path::PathBuf> {
    ...
    crate::image_generation::artifact_path(data_dir, session_id, artifact_id)
}
...
fn document_output(message: &str, manifest: &crate::documents::DocumentManifest) -> ToolOutput {
...
fn asset_exists(data_dir: &Path, id: &str, asset: &str) -> bool {
    crate::documents::resolve_asset(data_dir, id, asset).is_ok()
}
