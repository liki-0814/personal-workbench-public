...
use crate::app::cli::tui_app::{StatusUpdate, UiEvent, UserSubmission};
...
pub async fn capture_work_item(
    ...
    crate::app::config::local_config::init().await;
    crate::app::platform::daemon::start().await?;
    let daemon_url = crate::app::platform::daemon::status().await.http_address;
