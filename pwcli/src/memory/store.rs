...
use crate::memory::types::{MemoryEntry, MemoryIndex, MemoryIndexLine};
use chrono::Local;
use fs2::FileExt;
...
fn default_schema_version() -> u32 {
    crate::memory::types::CURRENT_SCHEMA_VERSION
}
...
impl MemoryStore {
    ...
    pub fn count_vector_index(&self) -> Option<usize> {
        ...
        crate::memory::index::MemoryIndexDb::open(&self.base_dir)
            .ok()
