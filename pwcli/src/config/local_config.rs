...
use crate::fusion::config::MoaConfig;
...
pub struct ToolsSection {
    ...
    pub ssh_servers: Vec<crate::tools::ssh::config::SshServer>,
}
...
impl<'de> Deserialize<'de> for ToolsSection {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct RawToolsSection {
            ...
            #[serde(default)]
            ssh_servers: Vec<crate::tools::ssh::config::SshServer>,
        }
    ...
    async fn nested_moa_serializes_harness_schema() {
        ...
        cfg.ai.moa = Some(MoaConfig {
            ...
            presets: std::collections::BTreeMap::from([(
                "review".into(),
                crate::fusion::MoaPreset {
                    advisors: vec![crate::fusion::MoaModelRef {
                        provider: "p".into(),
                        model: "a".into(),
                    }],
                    judge: crate::fusion::MoaModelRef {
                        provider: "p".into(),
                        model: "j".into(),
                    },
                    ..Default::default()
